...
-(void)makeUI{
    ...
    [_biggestButton setmystateString:@"0"];
    [_biggestButton setmyisnoBack:1];
    ...
    [_leftcolorButton setmystateString:@"0"];
    [_leftcolorButton setmyisnoBack:1];
  
    [_leftcolorButton setTitle:@"125" forState:UIControlStateNormal];
    _leftcolorButton.titleLabel.font = [UIFont fontWithName:@"Helvetica" size:20];
    ...
    [_rightcolorButton setmystateString:@"0"];
    [_rightcolorButton setmyisnoBack:1];
    
    [_rightcolorButton setTitle:@"+0.050%" forState:UIControlStateNormal];
    _rightcolorButton.titleLabel.font = [UIFont fontWithName:@"Helvetica" size:20];
